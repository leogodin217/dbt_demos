...
select 
    ...
    '{{ get_model_end_date(python_date('2023-12-05'), date_logic='run_at_day') }}' as actual_date 

union all 

-- run_at_week: Get the Sunday that ends the week 
select 
...
select 
    ...
    '2023-12-23' as expected_date,
    '{{ get_model_end_date(python_date('2023-12-21'), date_logic='run_at_week') }}' as actual_date 
...
select 
    ...
    '2023-12-23' as expected_date,
    '{{ get_model_end_date(python_date('2023-12-23'), date_logic='run_at_week') }}' as actual_date 

union all 
-- run_at_month: Should always return the last day of the month
 select 
    'run_at_month_start' as test_case,
    '2023-12-01' as run_at_date,
    '2023-12-31' as expected_date,
    '{{ get_model_end_date(python_date('2023-12-01'), date_logic='run_at_month') }}' as actual_date 
...
select 
    ...
    '2023-12-31' as expected_date,
    '{{ get_model_end_date(python_date('2023-12-15'), date_logic='run_at_month') }}' as actual_date 
...
select 
    ...
    '2023-12-31' as expected_date,
    '{{ get_model_end_date(python_date('2023-12-31'), date_logic='run_at_month') }}' as actual_date 
